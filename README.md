...
- Workspaces Own Terminals
    ...
    - Auto resize available, or manual drag to re-size or re-order
...
- **Return to workspace** — one-click action on terminal headers when cwd drifts outside workspace root
